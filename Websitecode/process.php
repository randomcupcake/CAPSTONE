...
if ($_SERVER["REQUEST_METHOD"] == "POST") {//Check it is comming from a form
	...
	$u_text = filter_var($_POST["user_comments"], FILTER_SANITIZE_STRING);
	...
	$statement = $mysqli->prepare("INSERT INTO users_data (user_name, user_email, user_comments) VALUES(?, ?, ?)"); //prepare sql insert query
